...
<h1 style="color:#FA8072;background-color:475710;border-radius:5px;width:68%;margin-left:90px;margin-top:-20px;height:60px;">Insert Room Details</h1>
</center>
...
<td align="center"><input type="text" name="rno" placeholder="Enter room number" required="*required" pattern="[0-9]*"><br></td>
</tr>
...
if(isset($_POST['submit']))
{
	$a=$_POST['rno'];
	$b=$_POST['type'];
	$query="insert into room values('$a','$b')"; 
