...
<h1 style="color:#FA8072;background-color:475710;border-radius:5px;width:68%;margin-left:90px;margin-top:-20px;height:60px;">Delete Record of Room</h1>
</center>

<table height="200" width="500" border="3" bordercolor="black" align="center" bgcolor="lightblue"style="margin-left:480px;"> 
<tr>
<td align="center">Room no:</td>
<td align="center"><input type="text" name="rno" placeholder="Enter Room no" required="*required" pattern="[0-9]*></td>
</tr>
<tr>
...
<?php
		...
		{
			$a=$_POST['rno'];
			$query="delete from room where roomno='$a'";
