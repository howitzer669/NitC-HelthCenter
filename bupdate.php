...
<h1 style="color:#FA8072;">Update Bill Details</h1>
</center>
</br></br></br></br></br>
<table height="300" width="500" border="3" bordercolor="black" align="center" bgcolor="lightblue"> 
<tr>
<tr>
<td align="center">Pc no:</td>
<td align="center"><input type="text" name="bno" placeholder="Enter concultation no" required="*required" pattern="[0-9]*"><br></td>
</tr>
...
<td align="center"><input type="text" name="bam" placeholder="Enter bill amount" required="*required" pattern="[0-9]*"><br></td>
</tr>
...
if(isset($_POST['submit']))
{
	...
	$d=$_POST['dch'];
	$e=$_POST['bam'];
	$query="update approval set billno='$a',doc_charges='$b',roomcharges='$c'where billno='$a'"; 
