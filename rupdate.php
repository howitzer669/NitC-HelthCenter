...
<h1 style="color:#FA8072;background-color:475710;border-radius:5px;width:68%;margin-left:90px;margin-top:-20px;height:60px;">Update Room Details</h1>
</center>
...
<td align="center"><input type="text" name="rno" placeholder="Enter room no" required="*required" pattern="[0-9]*"><br></td>
</tr>
<td align="center">Type:</td>
<td align="center"><input type="text" name="type" placeholder="Enter room type" required="*required" pattern="[a-zA-Z ]*"><br></td>
</tr>
<tr>
...
if(isset($_POST['submit']))
{
	$a=$_POST['rno'];
	$b=$_POST['type'];
	$query="update room set roomno='$a',type='$b' where roomno='$a'"; 
