...
<h1 style="color:#FA8072;">Delete Patient's Details</h1></br></br>
</center>
</br></br></br></br></br>
<table height="200" width="500" border="3" bordercolor="black" align="center" bgcolor="lightblue"> 
<tr>
<td align="center">Patient's Id:</td>
<td align="center"><input type="text" name="pid" placeholder="Enter Patient's Id" required="*required"></td>
</tr>
<tr>
...
<?php
		...
		{
			$a=$_POST['pid'];
			$query="delete from patient where pid='$a'";
